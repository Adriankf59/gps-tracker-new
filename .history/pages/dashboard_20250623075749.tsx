...
const useWebSocketWithGeofence = (userId?: string, user?: User | null) => {
  ...
  // Send email notification function - FIXED VERSION
  ...
  // FIXED handleRealtimeUpdate with retry logic
  const handleRealtimeUpdate = useCallback((message: any) => {
    ...
    if (data.vehicle_id && data.license_plate) {
      ...
      // GPS Data update - PERBAIKAN UTAMA DI SINI
      ...
      // PERBAIKAN: Gunakan Promise untuk memastikan vehicles sudah ter-load
