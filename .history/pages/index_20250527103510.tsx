    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-slate-100">
          ...
          <div className="flex justify-between items-center py-6">
            ...
            <div className="flex gap-3">
              <Link href="/login" passHref>
                <Button variant="outline" className="bg-white text-blue-600 border-blue-600 hover:bg-blue-50">Masuk</Button>
              </Link>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/register" passHref>
              <Button size="lg" className="text-lg px-8 py-3">Mulai Gratis</Button>
            </Link>
            <Link href="/login" passHref>
              <Button variant="outline" size="lg" className="text-lg px-8 py-3 bg-white">Sudah Punya Akun?</Button>
            </Link>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-blue-600">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <Link href="/register" passHref>
            <Button size="lg" variant="secondary" className="text-lg px-8 py-3">Daftar Sekarang</Button>
          </Link>
        </div>
      </section>
