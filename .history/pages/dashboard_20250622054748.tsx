...
const DashboardPage = () => {
  ...
  // Request notification permission - TAMBAHKAN SETELAH useEffect AUTHENTICATION
...
// Add this useEffect after user is authenticated
useEffect(() => {
  ...
  return (
    ...
    >
      ...
      <SidebarProvider>
        ...
        {/* Main Content Area */}
        <SidebarInset className={`flex flex-col w-full transition-all duration-300 ${sidebarCollapsed ? 'md:ml-0' : ''}`}>
          {/* Main Content Area - No headers */}
          <div className="flex-1 overflow-auto bg-gray-50">
            <div className={`p-0 md:p-6 transition-all duration-300 ${sidebarCollapsed ? 'md:pl-20' : ''}`}>
              <CleanMainContent 
                activeView={activeView} 
                user={user}
