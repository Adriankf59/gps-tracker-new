...
const COMPONENT_REGISTRY: Record<string, ComponentConfig> = {
  ...
  geofences: {
    ...
    requiredPermissions: ['view_geofences', 'manage_geofences'],
  ...
  alerts: {
    ...
    requiredPermissions: ['view_alerts', 'manage_alerts'],
  },
  commands: {
    component: CommandCenter,
    title: 'Command Center',
    description: 'Send remote commands to vehicles',
    requiredPermissions: ['view_commands', 'send_commands'],
    subscriptionRequired: 'premium',
  },
  history: {
    ...
    requiredPermissions: ['view_history'],
  },
  users: {
