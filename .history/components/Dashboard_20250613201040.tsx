...
export function Dashboard() {
  ...
  return (
    <div className="space-y-6">
      {/* Full Screen Map */}
      <div className="relative h-[calc(100vh-12rem)] w-full rounded-lg overflow-hidden bg-gray-100">
        ...
        {/* Vehicle Selection Info - Only this overlay remains */}
        {selectedVehicleId && (
      ...
      {/* Bottom Section - Activity and Vehicles */}
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {/* Recent Activity - Compact with scroll */}
        <Card>
        ...
        {/* Online Vehicles - Compact with scroll */}
        <Card>
          <CardHeader className="pb-3">
            <CardTitle className="flex items-center gap-2 text-base">
