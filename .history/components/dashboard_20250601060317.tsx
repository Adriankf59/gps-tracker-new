...
const useVehicleData = (userId?: string) => {
  const { data, error, isLoading, mutate } = useSWR(
    userId ? `http://ec2-13-229-83-7.ap-southeast-1.compute.amazonaws.com:8055/items/vehicle_datas?filter[user_id][_eq]=${userId}&limit=1000&sort=-timestamp` : null,
    fetcher,
    {
...
export function Dashboard() {
  ...
  const { vehicleData, vehicleDataLoading, vehicleDataError, mutateVehicleData } = useVehicleData(userId);
