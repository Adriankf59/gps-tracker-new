...
// Enhanced interface dengan WebSocket data props
    ...
    <div className="flex items-center justify-center min-h-[400px] p-4">
      <Card className="w-full max-w-md border-red-200 bg-red-50">
        ...
        <CardContent className="text-center space-y-4">
          <div className="text-sm text-red-700 bg-red-100 p-3 rounded border break-words">
...
// Generic Component Props Interface - Updated with WebSocket data
  ...
  return (
    <div className="flex items-center justify-center min-h-[400px] p-4">
      <Card className="w-full max-w-2xl border-blue-200 bg-blue-50">
        <CardHeader className="text-center">
          <CardTitle className="text-blue-800 text-xl sm:text-2xl">Dashboard</CardTitle>
  ...
  return (
    <div className="flex items-center justify-center min-h-[400px] p-4">
      <Card className="w-full max-w-2xl border-green-200 bg-green-50">
        <CardHeader className="text-center">
          <CardTitle className="text-green-800 text-xl sm:text-2xl">Vehicle Manager</CardTitle>
        ...
        <CardContent className="text-center space-y-4 sm:space-y-6">
          ...
          <Button onClick={() => onViewChange?.('dashboard')} className="bg-green-600 hover:bg-green-700 w-full sm:w-auto">
            Back to Dashboard
          </Button>
        </CardContent>
      </Card>
  ...
  return (
    <div className="flex items-center justify-center min-h-[400px] p-4">
      <Card className="w-full max-w-2xl border-red-200 bg-red-50">
        <CardHeader className="text-center">
          <CardTitle className="text-red-800 text-xl sm:text-2xl">Live Tracking</CardTitle>
        ...
        <CardContent className="text-center space-y-4 sm:space-y-6">
          ...
          <Button onClick={() => onViewChange?.('dashboard')} className="bg-red-600 hover:bg-red-700 w-full sm:w-auto">
            Back to Dashboard
          </Button>
        </CardContent>
      </Card>
  ...
  return (
    <div className="flex items-center justify-center min-h-[400px] p-4">
      <Card className="w-full max-w-2xl border-purple-200 bg-purple-50">
        <CardHeader className="text-center">
          <CardTitle className="text-purple-800 text-xl sm:text-2xl">Geofence Manager</CardTitle>
        ...
        <CardContent className="text-center space-y-4 sm:space-y-6">
          ...
          <Button onClick={() => onViewChange?.('dashboard')} className="bg-purple-600 hover:bg-purple-700 w-full sm:w-auto">
            Back to Dashboard
          </Button>
        </CardContent>
      </Card>
  ...
  return (
    <div className="flex items-center justify-center min-h-[400px] p-4">
      <Card className="w-full max-w-2xl border-orange-200 bg-orange-50">
        <CardHeader className="text-center">
          <CardTitle className="text-orange-800 text-xl sm:text-2xl">Alert Manager</CardTitle>
        ...
        <CardContent className="text-center space-y-4 sm:space-y-6">
          ...
          <Button onClick={() => onViewChange?.('dashboard')} className="bg-orange-600 hover:bg-orange-700 w-full sm:w-auto">
            Back to Dashboard
          </Button>
        </CardContent>
      </Card>
  ...
  return (
    <div className="flex items-center justify-center min-h-[400px] p-4">
      <Card className="w-full max-w-2xl border-indigo-200 bg-indigo-50">
        <CardHeader className="text-center">
          <CardTitle className="text-indigo-800 text-xl sm:text-2xl">Command Center</CardTitle>
        ...
        <CardContent className="text-center space-y-4 sm:space-y-6">
          ...
          <Button onClick={() => onViewChange?.('dashboard')} className="bg-indigo-600 hover:bg-indigo-700 w-full sm:w-auto">
            Back to Dashboard
          </Button>
        </CardContent>
      </Card>
  ...
  return (
    <div className="flex items-center justify-center min-h-[400px] p-4">
      <Card className="w-full max-w-2xl border-teal-200 bg-teal-50">
        <CardHeader className="text-center">
          <CardTitle className="text-teal-800 text-xl sm:text-2xl">User Manager</CardTitle>
          <CardDescription className="text-teal-600 text-sm sm:text-base">
        ...
        <CardContent className="text-center space-y-4 sm:space-y-6">
          ...
          <Button onClick={() => onViewChange?.('dashboard')} className="bg-teal-600 hover:bg-teal-700 w-full sm:w-auto">
            Back to Dashboard
          </Button>
        </CardContent>
      </Card>
  ...
  return (
    <div className="flex items-center justify-center min-h-[400px] p-4">
      <Card className="w-full max-w-2xl border-gray-200 bg-gray-50">
        <CardHeader className="text-center">
          <CardTitle className="text-gray-800 text-xl sm:text-2xl">Settings Panel</CardTitle>
        ...
        <CardContent className="text-center space-y-4 sm:space-y-6">
          ...
          <Button onClick={() => onViewChange?.('dashboard')} className="bg-gray-600 hover:bg-gray-700 w-full sm:w-auto">
            Back to Dashboard
          </Button>
        </CardContent>
      </Card>
  ...
  return (
    <div className="flex items-center justify-center min-h-[400px] p-4">
      <Card className="w-full max-w-2xl border-cyan-200 bg-cyan-50">
        <CardHeader className="text-center">
          <CardTitle className="text-cyan-800 text-xl sm:text-2xl">History Manager</CardTitle>
          <CardDescription className="text-cyan-600 text-sm sm:text-base">
        ...
        <CardContent className="text-center space-y-4 sm:space-y-6">
          ...
          <Button onClick={() => onViewChange?.('dashboard')} className="bg-cyan-600 hover:bg-cyan-700 w-full sm:w-auto">
            Back to Dashboard
          </Button>
        </CardContent>
      </Card>
...
// ========================================
// 🎯 MAIN CONTENT COMPONENT (MOBILE OPTIMIZED)
// ========================================
...
export const CleanMainContent: React.FC<MainContentProps> = ({ 
        ...
        <PermissionGuard componentName={componentConfig.title}>
          ...
          >
            <ComponentToRender 
              ...
              // Pass WebSocket data to components
  ...
  }, [componentConfig, user, systemStatus, onViewChange, activeView, handleErrorReset, isConnected, vehicles, vehicleData, geofences, alerts, onRefresh]);
