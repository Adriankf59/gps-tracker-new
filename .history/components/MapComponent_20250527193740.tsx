...
const MapComponent: React.FC<MapComponentProps> = ({ 
  ...
  return (
    <div className="relative">
      ...
      {/* Legend overlay */}
      {mapLoaded && (
        <div className="absolute bottom-4 right-4 bg-white bg-opacity-95 backdrop-blur-sm p-4 rounded-lg shadow-lg text-xs z-[1000] max-w-xs border">
          <div className="space-y-3">
            <div className="font-medium text-gray-800 border-b pb-2">Map Legend</div>
            ...
            <div className="flex items-center justify-between pt-2 border-t">
              <div className="flex items-center space-x-3">
                <div className="flex items-center">
                  <div className="w-5 h-5 bg-blue-500 mr-1 rounded-full flex items-center justify-center text-[10px]">🚗</div>
                  <span className="text-xs">Car</span>
                </div>
                <div className="flex items-center">
                  <div className="w-5 h-5 bg-green-500 mr-1 rounded-full flex items-center justify-center text-[10px]">🏍️</div>
                  <span className="text-xs">Motor</span>
                </div>
              </div>
            </div>
            
            {mapVehicles && mapVehicles.length > 0 ? (
              <div className="pt-2 border-t">
                <div className="text-green-600 font-medium">{vehiclesCount} vehicles tracked</div>
                <div className="text-xs text-gray-500">{onlineCount} currently online</div>
                <div className="text-xs text-blue-600">Auto-refresh: {refreshInterval / 1000}s</div>
                {isDateFiltered && (
              ...
              <div className="pt-2 border-t text-yellow-600 text-xs">
