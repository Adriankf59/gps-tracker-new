...
export function Dashboard() {
  ...
  const fetchData = async () => {
    try {
      ...
      console.log('Vehicles received:', vehiclesList.length);
      console.log('Vehicle data records received:', vehicleDataList.length);
      ...
      console.log('Dashboard stats:', { totalVehicles, activeTracking, activeAlerts });
