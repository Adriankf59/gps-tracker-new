    ...
    const loadMapComponents = async () => {
      try {
        ...
        function DrawControlWrapper({
          ...
          // Create and manage feature group
          useEffect(() => {
            if (!featureGroup.current && map) {
              featureGroup.current = L.featureGroup().addTo(map);
              featureGroupRef.current = featureGroup.current;
          ...
          if (!featureGroup.current || !currentlyCreating || isViewOnly) {
            return null;
          }
