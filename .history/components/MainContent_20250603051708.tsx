...
// Lazy loaded components dengan fallback ke local components jika import gagal
const Dashboard = lazy(() => 
  import('@/components/Dashboard').catch(err => {
    console.warn('Dashboard component not found, using fallback');
    return import('@/components/FallbackComponents').then(module => ({ default: module.Dashboard }));
  })
);
...
const VehicleManager = lazy(() => 
  import('@/components/VehicleManager').catch(err => {
    ...
    return import('@/components/FallbackComponents').then(module => ({ default: module.VehicleManager }));
  })
);
...
const LiveTracking = lazy(() => 
  import('@/components/LiveTracking').catch(err => {
    ...
    return import('@/components/FallbackComponents').then(module => ({ default: module.LiveTracking }));
  })
);
...
const GeofenceManager = lazy(() => 
  import('@/components/GeofenceManager').catch(err => {
    ...
    return import('@/components/FallbackComponents').then(module => ({ default: module.GeofenceManager }));
  })
);
...
const AlertManager = lazy(() => 
  import('@/components/AlertManager').catch(err => {
    ...
    return import('@/components/FallbackComponents').then(module => ({ default: module.AlertManager }));
  })
);
...
const CommandCenter = lazy(() => 
  import('@/components/CommandCenter').catch(err => {
    ...
    return import('@/components/FallbackComponents').then(module => ({ default: module.CommandCenter }));
  })
);
...
const UserManager = lazy(() => 
  import('@/components/UserManager').catch(err => {
    ...
    return import('@/components/FallbackComponents').then(module => ({ default: module.UserManager }));
  })
);
...
const SettingsPanel = lazy(() => 
  import('@/components/SettingsPanel').catch(err => {
    ...
    return import('@/components/FallbackComponents').then(module => ({ default: module.SettingsPanel }));
  })
);
...
const HistoryManager = lazy(() => 
  import('@/components/HistoryManager').catch(err => {
    ...
    return import('@/components/FallbackComponents').then(module => ({ default: module.HistoryManager }));
  })
);
