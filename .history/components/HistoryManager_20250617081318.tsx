...
export function HistoryManager() {
  ...
  const routePolyline = useMemo(() => {
    ...
    const vehicleRouteData = filteredVehicleData
      .filter(data => data.gps_id === vehicle.gps_id)
      .sort((a, b) => new Date(a.timestamp!).getTime() - new Date(b.timestamp!).getTime());

    console.log(`Route data for ${vehicle.name}:`, vehicleRouteData.length, 'points');
  ...
  }, [filteredVehicleData, showAllVehicles, selectedVehicle, vehicles]);
