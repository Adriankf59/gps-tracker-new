...
export function Dashboard() {
  ...
  return (
    <div className="space-y-6">
      {/* Stats Cards - 5 cards in responsive grid */}
              ...
              <div className="space-y-3 pr-2">
                {recentActivity.length > 0 ? (
                  recentActivity.map((activity, index) => (
                    <div key={activity.id} className={`flex items-start gap-3 p-3 rounded-lg hover:bg-slate-50 ${index === 0 ? '' : 'border-t border-slate-100'}`}>
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-sm text-slate-600 line-clamp-2">{activity.event}</p>
                ...
                {onlineVehicles.length > 0 ? (
                  processedVehicles.filter(v => v.isOnline).map((vehicle, index) => (
                    ...
                    >
                      ...
                      <p className="text-sm text-slate-600 mb-2 truncate">{vehicle.location}</p>
                  ...
                  <div className="text-center py-6">
                    ...
                    <p className="text-slate-500 text-sm">No vehicles online</p>
                    <p className="text-xs text-slate-400 mt-1">
