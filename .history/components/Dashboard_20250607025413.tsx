...
// 🔥 FIXED: VehicleData interface sesuai format API yang sebenarnya
interface VehicleData {
  vehicle_datas_id: string;
  latitude: string | null;     // FIXED: latitude as string
  longitude: string | null;    // FIXED: longitude as string  
  speed: number | null;
  rpm: number | null;
  fuel_level: string | null;   // FIXED: fuel_level as string
  ignition_status: string | null;
  battery_level: number | null; // FIXED: battery_level as number
  satellites_used: number | null;
  timestamp: string | null;
  gps_id: string;              // FIXED: Only gps_id, no vehicle_id
}
