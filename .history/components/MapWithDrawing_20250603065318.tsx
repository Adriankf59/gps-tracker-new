...
export default function MapWithDrawing({
  ...
  return (
    <div ref={mapContainerRef} className="h-full w-full rounded-md overflow-hidden relative">
      ...
      {/* Debug Info */}
      {isCreating && (
        <div className="absolute top-4 left-4 bg-blue-50 border border-blue-200 rounded-lg p-3 shadow-lg z-[1000]">
          <div className="text-xs text-blue-700">
            <p className="font-semibold mb-1">🎨 Drawing Mode Active</p>
            <p>Mode: <span className="font-mono">{drawMode}</span></p>
            <p>Look for drawing tools on the right side of the map!</p>
          </div>
        </div>
      )}
    </div>
