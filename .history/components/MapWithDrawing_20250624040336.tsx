        ...
        function DrawControlWrapper({
          ...
          useEffect(() => {
            ...
            if (currentlyCreating && !drawControlLocal.current) {
              ...
              console.log('✅ CREATED event listener attached');

              // Test if events are working
              map.on('draw:drawstart', () => console.log('📐 Draw started'));
              map.on('draw:drawstop', () => console.log('🛑 Draw stopped'));
              map.on('draw:drawvertex', () => console.log('📍 Vertex added'));
